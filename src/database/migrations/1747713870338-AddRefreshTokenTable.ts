...
export class AddRefreshTokenTable1747713870338 implements MigrationInterface {
    name = 'AddRefreshTokenTable1747713870338'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "value" varchar NOT NULL, "userId" varchar NOT NULL, "expiresAt" integer NOT NULL)`);
